...
- `references/AGENT_FRAMEWORKS.md` — when the user thinks this is just DSPy / LangGraph / AutoGen / CrewAI / pydantic with a coat of theory; positions hybrid loops as the unifying vocabulary the ecosystem lacks
