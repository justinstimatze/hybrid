---
name: hybrid-loops
description: Find and design hybrid-loop surfaces in any complex project — places where an LLM's fuzzy semantic judgment is consequential enough to warrant typed structure (schema'd substrate, deterministic gating, calibration). Diagnostic-first — most projects have only 0-3 such surfaces. Domain-agnostic. Skip for pure UIs, simple CRUD, deterministic computation, or chatbots.
---
